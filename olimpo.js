        ...
        if (!err) {
            ...
            if (result && result.length > 0) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    html += "<tr><td>" + result[i].titulo_filme + "</td><td>" + result[i].nome_diretor + "</td><td>" + result[i].ano_filme + "</td><td>" + result[i].runtime_filme + " min.</td><td>" + result[i].classificacao_filme + "</td><td>" + result[i].premios_filme + "</td><td>" + result[i].nome_genero + "</td><td><img class='poster_filme' src='recursos/posteres_filmes/" + result[i].poster_filme + "' alt='Poster do filme'></td></tr>\n";
                    console.log(i);
                }
                html += "</table>\n";
                html += "</div>"
...
/*_______________________________________________Original__________________________________________________*/
/*______________________________________________________________________________________________________*/
    ...
    if (req.session.id_funcionario) {
        ...
        pool.query(query, function (err, result, fields) {
            ...
            if (!err) {
                for (var i = 0; i < result[0].length; i++) {
                    html += "<div class=''>";
                    html += "<div><a href= '/consulta" + result[0][i].titulo_filme + "'><img src='recursos/posteres_filmes/" + result[0][i].poster_filme + "' alt='poster do filme'></a></div>";
                    html += "</div>";
                }
                ...
                html += "<p>" + result[1].titulo_filme + "</p>";
                for (var i = 0; i < result[1].length; i++) {
        ...
        html += "<h2>Não tens premissão para estar nesta página</h2>\n";
        html += footer;
        res.send(html);
    }
